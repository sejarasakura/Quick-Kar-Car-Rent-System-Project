            ...
            <table class="table table-bordered table-striped">
              ...
              <tbody id="myTable">
                <%
                    ...
                    Object[] bookings = booking.getRecords(" SUBSTR(driver_id, 1, 1) = \'E\'");
                %>
                ...
                <%Driver b = (Driver)bookings[i];%>
                    <tr>
                        ...
                        <td><%= b.getLicense()%></td>
                        <td>
                            <a href="conti_approve.jsp?id=<%=b.getDriver_id()%>" class="btn btn-warning"></a>
                        </td>
                    </tr>
                <%}%>
              </tbody>
            </table>
            <p>Approve the driver work with our company!!</p>
          </div>
        <div id="footer"></div>
    </body>
<script>
