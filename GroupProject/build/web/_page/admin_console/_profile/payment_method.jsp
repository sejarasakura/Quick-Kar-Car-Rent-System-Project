...
<html>
    <head>
        <title>Admin console - payment method details</title>
    ...
    <body>
        <%
            ...
            PaymentMethodDA driver_da = new PaymentMethodDA();
            PaymentMethod cust = (PaymentMethod)driver_da.getRecord(id);
        %>
        <div id="header"></div>
        <div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        <h3>
                            <div class="row">
                            <div class="col-sm-6 text-right">Payment Method ID :</div>
                            <div class="col-sm-6 text-left"><%= cust.getPay_method_id()%></div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6 text-right">User ID :</div>
                            <%
                                String class_user = "";
                                if(cust.getUser().length() >= 11){
                                    class_user = "customer";
                                }else{
                                    class_user = "driver";
                                }
                            ...
                            <div class="col-sm-6 text-left">
                                <a href="<%= class_user%>.jsp?id=<%= cust.getUser()%>">
                                    <%= cust.getUser()%>
                                </a>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-sm-6 text-left"><%= cust.getPay_method().getName()%></div>
                        </div>
                        <%if(cust.getCard_num() != null){%>
                        <div class="row">
                            <div class="col-sm-6 text-right">CArd Number :</div>
                            <div class="col-sm-6 text-left"><%= cust.getCard_num()%></div>
                        </div>
                        <%}%>
