...
<html>
    <head>
        <title>Admin console - Booking [view]</title>
    ...
    <body>
        <div id="header"></div>
        <br>
        <h1 class="text-center">Display Booking Module</h1>
        <br>
        <div class="container">
              ...
              <tbody id="myTable">
                ...
                <%Booking b = (Booking)bookings[i];%>
                    <tr>
                        ...
                        <td><a href="<%= URL_PART%>rating.jsp?id=<%= b.getRating().getRating_id()%>"><%= b.getRating().getRating_id()%></a></td>
                    </tr>
                <%}%>
              </tbody>
            </table>
