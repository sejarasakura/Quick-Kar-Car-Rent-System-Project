...
<html>
    ...
    <body>
        <div id="header"></div>
        <br>
        <h1 class="text-center">Update Customer Module</h1>
        <br>
        <div class="container">
              ...
              <tbody id="myTable">
                ...
                <%Customer b = (Customer)bookings[i];%>
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-success" href="update_customer_conti.jsp?id=<%= b.getCust_id()%>">Update</a>
                        </td>
                    </tr>
                <%}%>
              </tbody>
            </table>
            <p>Note that after update customer cannot be change reverse back to un previos from database forever!!</p>
          </div>
        <div id="footer"></div>
    </body>
