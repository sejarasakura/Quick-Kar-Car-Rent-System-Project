...
<%
    ...
    cs.retriveSeesion(request);
    String id = cs.getUsername();
...
<body>
    ...
    <div class="container center-block small" style="width: 500px">
        <h3 class="booking">Select Your Location</h3>
        <form class="booking" action="payment.html" method="post">
            <div class="form-group row">
                <div class="col-sm-6">Phone number:</div>
                <div class="col-sm-6"><input type="text" class="form-control" id="fetch_date" value="<%= formatter.format(new Date())%>" placeholder="Enter phone number format 6018-999-9999" name="fetch_date"></div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row c_map_flip" id="flip_sl">
                ...
                <div class="col-sm-6"><input type="text" class="form-control controls" id="start_location" value="" placeholder="Search a start location" name="start_location" disabled=""></div>
            </div>
            ...
            <div class="form-group row c_map_flip" id="flip_el">
                ...
                <div class="col-sm-6"><input type="text" class="form-control controls" id="end_location" value="" placeholder="Search a end location" name="end_location" disabled=""></div>
            </div>
