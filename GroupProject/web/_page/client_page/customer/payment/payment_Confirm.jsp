...
<body>
    ...
    <div class="payment">
        ...
        <div class="form">
            <div>
                <a class="btn btn-info" href="http://localhost:8080/GroupProject/_page/client_page/customer/payment/payment_Cash.jsp">
                Pay in Cash
                </a>
            </div>
            
            <div>
                <a class="btn btn-info" href="http://localhost:8080/GroupProject/_page/client_page/customer/payment/payment_eWallet.jsp">
                Pay in eWallet
                </a>
            </div>

            <div>
                <a class="btn btn-info" href="http://localhost:8080/GroupProject/_page/client_page/customer/payment/payment_Card.jsp">
