...
<html>
    ...
    <body>
        <div id="header"></div>
        <br>
        <h1 class="text-center">Update Driver Module</h1>
        <br>
        <div class="container">
            ...
            <table class="table table-bordered table-striped">
              ...
              <tbody id="myTable">
                <%
                    ...
                    Object[] drivers = driver.getRecords();
                %>
                <%for(int i = 0; i < drivers.length; i++){ %>
                <%Driver b = (Driver)drivers[i];%>
                    <tr>
                        <td>
                        ...
                        <td><%= b.getLicense()%></td>
                        <td>
                            <a href="update_driver_conti.jsp?id=<%=b.getDriver_id()%>" class="btn btn-success">Update</a>
                        </td>
                    </tr>
                <%}%>
              </tbody>
            </table>
            <p>Update the driver work with our company!!</p>
          </div>
        <div id="footer"></div>
    </body>
<script>
