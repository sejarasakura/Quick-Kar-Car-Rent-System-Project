...
<html>
    <head>
        <title>Admin console - Booking [cancel]</title>
    ...
    <body>
        <div id="header"></div>
        <br>
        <h1 class="text-center">Cancel Booking Module</h1>
        <br>
        <div class="container">
            ...
            <table class="table table-bordered table-striped">
              ...
              <script>
                  function cancel_booking_s(id){
                    var valid = confirm("Do you sure want to cancel the booking process with id of " + id); 
                    if(!valid)
                        return
                    
                    var link = "http://localhost:8080/GroupProject/_page/admin_console/_profile/cancel_booking.jsp?id=" + id;
              ...
              <tbody id="myTable">
                <%
                    ...
                    Object[] bookings = booking.getRecords("booking_status = 'B1' OR booking_status = 'B5'");
                %>
                ...
                <%Booking b = (Booking)bookings[i];%>
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-danger" href="cancel_booking_action.jsp?id=<%= b.getBooking_id()%>">
                                Cancel
                            </a>
                        </td>
                    </tr>
