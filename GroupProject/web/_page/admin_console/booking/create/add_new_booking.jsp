...
<html>
        ...
        <script>
            ...
            jQuery(document).ready(
                function(){
                    ...
                    choices_payment_method = <%= payment_method_list%>;
                    ...
                    $("#payment_method_id").autocomplete({minChars:2,source:choices_payment_method});
                }
            );
    ...
    <body>
        ...
        <h4>Booking ID : <%= id%></h4>
        <form id="createform" method="post" action="/GroupProject/admin_addBooking">
            ...
            <div class="form-group row">
                <div class="col-sm-6">Rating ID</div>
                <div class="col-sm-6"><input type="text" class="form-control" id="rating_id" value="<%= rating.getRating_id()%>" name="rating_id" disabled=""></div>
            </div>  
            <div class="form-group row">
                <div class="col-sm-6">Customer ID:</div>
                <div class="col-sm-6"><input type="text" class="form-control" id="cust_id" value="" placeholder="Enter customer id" name="cust_id"></div>
            </div>
            <div class="form-group row">
                <div class="col-sm-6">Driver ID:</div>
                <div class="col-sm-6"><input type="text" class="form-control" id="driver_id" value="" placeholder="Enter driver id" name="driver_id"></div>
            </div>
            <div class="form-group row">
                <div class="col-sm-6">Payment Method ID:</div>
                <div class="col-sm-6"><input type="text" class="form-control" id="payment_method_id" value="" placeholder="Enter payment method id" name="payment_method_id"></div>
            </div>
            <div class="form-group row">
                <div class="col-sm-6">Booking Date:</div>
                <div class="col-sm-6"><input type="datetime-local" class="form-control" id="booking_date" value="<%= formatter.format(new Date())%>" placeholder="Enter booking date" name="booking_date" disabled></div>
            </div>
            <div class="form-group row">
                <div class="col-sm-6">Fetch Date:</div>
                <div class="col-sm-6"><input type="datetime-local" class="form-control" id="fetch_date" value="<%= formatter.format(new Date())%>" placeholder="Enter fetch date" name="fetch_date"></div>
            </div>
            <div class="form-group row">
                <div class="col-sm-6">Booking Status:</div>
                <div class="col-sm-6"><input type="text" class="form-control" id="booking_status" value="" placeholder="Enter booking status" name="booking_status"></div>
            </div>
